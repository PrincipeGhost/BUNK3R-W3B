...
Rama Git: feature/frontend-user Comando para activar: 3 o FRONTEND Responsabilidad: Todo el frontend del usuario final, incluyendo workspace de IA
...
Rama Git: feature/backend-api Comando para activar: 4 o BACKEND Responsabilidad: API principal, base de datos y motor de IA
...
Guarda, haz git add . y git commit
...
Botones: Cada botón DEBE tener su evento y ejecutar una acción real
Links/Navegación: Cada link DEBE llevar a una página/sección que EXISTA
Formularios: Cada formulario DEBE enviar datos al backend correctamente
Modales: Cada modal DEBE abrirse, cerrarse y funcionar completamente
Tablas: Los datos DEBEN cargarse de la base de datos real, NO datos mock
Filtros/Búsquedas: DEBEN filtrar datos realmente, no ser solo visuales
Paginación: DEBE funcionar con datos reales
Gráficos: DEBEN mostrar datos reales de la BD
Acciones: Aprobar, rechazar, banear, etc. DEBEN ejecutarse en el backend
...
Acceso: Solo usuarios con is_owner = true o rol admin Ruta: /admin o sección especial en la app Seguridad: Requiere 2FA + validación de IP

═══════════════════════════════════════
FASE 27.1: DASHBOARD PRINCIPAL ✅
═══════════════════════════════════════
Agente: 🟢 FRONTEND ADMIN Archivos: static/js/admin.js, static/css/admin.css, templates/admin.html
...
═══════════════════════════════════════
Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API Archivos Frontend: static/js/admin.js, templates/admin.html Archivos Backend: app.py, tracking/database.py
...
27.2.2 - Detalle de Usuario (al hacer clic)
 ...
 Historial de sesiones (Activity Log)
...
27.4.4 - Historial Blockchain
 ...
 Link a TonScan por transacción
═══════════════════════════════════════
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API Archivos Frontend: static/js/admin.js, templates/admin.html Archivos Backend: app.py, tracking/database.py Completado: 7 Diciembre 2025
...
═══════════════════════════════════════
Prioridad: 🟢 MEDIA Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API Completado: 7 Diciembre 2025
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Agente: 🟡 BACKEND API Completado: 7 Diciembre 2025
...
═══════════════════════════════════════
Prioridad: 🟢 MEDIA Tiempo: 6 horas Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟠 MEDIA Tiempo: 4 horas Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Tiempo: 5 horas Agente: 🟡 BACKEND API + 🟢 FRONTEND ADMIN
...
═══════════════════════════════════════
Prioridad: 🟠 MEDIA Tiempo: 4 horas Agente: 🟡 BACKEND API + 🟢 FRONTEND ADMIN
...
═══════════════════════════════════════
Prioridad: 🟢 BAJA Tiempo: 3 horas Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟠 MEDIA Tiempo: 3 horas Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟢 BAJA Tiempo: 4 horas Agente: 🟢 FRONTEND ADMIN + 🟡 BACKEND API
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Tiempo: 6 horas Agente: 🟡 BACKEND API + 🟢 FRONTEND ADMIN
...
════════════════════════════════════════════════════════════════
Prioridad: 🟡 ALTA
Agente: 🔵 FRONTEND USUARIO + 🟡 BACKEND API Archivos Frontend: static/js/app.js, static/css/styles.css, templates/index.html Archivos Backend: app.py, tracking/database.py Completado: 7 Diciembre 2025
...
CAMBIOS REALIZADOS:
Agregado cover/banner con gradiente y efecto de luz
Avatar con ring dorado y indicador de estado online
Seccion de info con nombre, username, badge de rol (Owner/Premium/Miembro)
Stats card con divisores y efecto hover interactivo
Wallet quick card con balance B3C y navegacion a wallet
Botones de accion con iconos SVG (Editar, Compartir, Configuracion)
Grid de publicaciones con hover overlay estilo Instagram
Badge de verificacion animado con pulse effect
════════════════════════════════════════════════════════════════
SECCIÓN 29: CONFIGURACIÓN COMPLETA DEL USUARIO ⏳
════════════════════════════════════════════════════════════════
Prioridad: 🟡 ALTA
Agregado: 7 Diciembre 2025 Agente: 🔵 FRONTEND USUARIO + 🟡 BACKEND API Archivos Frontend: static/js/app.js, static/css/styles.css, templates/index.html Archivos Backend: app.py, tracking/database.py, tracking/security.py Tiempo estimado: 18 horas
...
═══════════════════════════════════════
Prioridad: 🔴 CRÍTICA Tiempo: 2 horas Agente: 🔵 FRONTEND USUARIO
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Tiempo: 2 horas Agente: 🔵 FRONTEND + 🟡 BACKEND
...
═══════════════════════════════════════
Prioridad: 🔴 CRÍTICA Tiempo: 3 horas Agente: 🔵 FRONTEND + 🟡 BACKEND
...
═══════════════════════════════════════
Prioridad: 🟠 MEDIA Tiempo: 2 horas Agente: 🔵 FRONTEND + 🟡 BACKEND
...
═══════════════════════════════════════
Prioridad: 🟠 MEDIA Tiempo: 1.5 horas Agente: 🔵 FRONTEND
...
═══════════════════════════════════════
Prioridad: 🔴 CRÍTICA Tiempo: 2 horas Agente: 🔵 FRONTEND + 🟡 BACKEND + 🔴 BLOCKCHAIN
...
═══════════════════════════════════════
Prioridad: 🟢 BAJA Tiempo: 1.5 horas Agente: 🔵 FRONTEND + 🟡 BACKEND
...
═══════════════════════════════════════
Prioridad: 🟢 BAJA Tiempo: 1 hora Agente: 🔵 FRONTEND
...
═══════════════════════════════════════
Prioridad: 🟡 ALTA Tiempo: 1 hora Agente: 🔵 FRONTEND + 🟡 BACKEND
...
Prioridad: 🔴 CRÍTICA
Tiempo: 4 horas
Agente: 🔵 FRONTEND USUARIO + 🟢 FRONTEND ADMIN Progreso: 85% - 7 Diciembre 2025

Objetivo:
Implementar DOMPurify para sanitizar los 351 usos de innerHTML.

Tareas:
 Añadir DOMPurify CDN en de todos los templates:
 templates/index.html (ya tenía)
 templates/admin.html (ya tenía)
 templates/virtual_numbers.html (ya tenía)
 templates/workspace.html (agregado)
 Crear función SafeDOM.setHTML() en static/js/utils.js (global):
const SafeDOM = {
 ...
 static/js/app.js - Eliminada duplicación SafeDOM, usa global de utils.js
 static/js/publications.js - renderFeed() usa SafeDOM.setHTML()
 static/js/admin.js - renderUsersTable() usa SafeDOM.setHTML()
...
MEJORA ADICIONAL (7 Dic 2025):
 ...
 Añadida función escapeForOnclick() en utils.js para escapar valores en onclick handlers
 admin.js renderUsersTable() ahora usa escapeForOnclick() para user_id en handlers onclick
...
Criterios de éxito:
 ...
 SafeDOM.setHTML() disponible globalmente (window.SafeDOM)
 Funciones de escape (escapeHtml, escapeAttribute, sanitizeForJs) usadas en 133+ lugares
...
Prioridad: 🟠 MEDIA
Tiempo: 1 hora
Agente: 🟡 BACKEND API Completado: 7 Diciembre 2025

Objetivo:
Limpiar los imports no utilizados reportados por LSP.

Tareas:
 Limpiar imports en app.py - Consolidados al principio del archivo
 Limpiar imports en tracking/ai_service.py - Ya estaban correctos
...
Criterios de éxito:
 0 warnings de imports no usados en LSP (los 368 restantes son errores de tipado de Pyright, no imports)
...
Prioridad: 🔴 CRÍTICA
Tiempo: 4 horas
Agente: 🔵 FRONTEND USUARIO + 🟢 FRONTEND ADMIN Verificado: 7 Diciembre 2025 - Funciones YA IMPLEMENTADAS
...
31.1.1 - Funciones vacías en app.js:
 ...
 setupAvatarUpload() (línea ~1983-2008) - ✅ IMPLEMENTADO con event listeners completos
 viewUserProfile(userId) (línea ~2158-2183) - ✅ IMPLEMENTADO con modal de perfil y API
 Implementar navegación real a perfil de usuario con datos reales - ✅ showUserProfileModal() implementado
...
31.1.3 - MultiBrowser Module:
 ...
 closeMultiBrowserModule() (línea ~3550-3557) - ✅ IMPLEMENTADO correctamente
 Revisar toda la funcionalidad del módulo MultiBrowser - ✅ initMultiBrowsers() implementado
Criterios de éxito:
...
Prioridad: 🟡 ALTA
Tiempo: 3 horas
Agente: 🔵 FRONTEND USUARIO Completado: 8 Diciembre 2025
...
Tareas:
 Auditar función handleBottomNav() en app.js (línea ~1311) - ✅ Verificado
 Verificar que cada caso del switch tiene su página correspondiente en el HTML - ✅ Todas existen
 Verificar que showPage() valida si la página existe antes de mostrarla - ✅ Línea 1439-1442
 Agregar fallback a página de error o home si la página no existe - ✅ Ya implementado goToHome()
 Documentar todas las páginas disponibles en la navegación - ✅ 9 páginas verificadas
Páginas verificadas:
 home - Existe en index.html línea 591
 marketplace - Existe en index.html línea 656
 bots - Existe en index.html línea 678
 ai-chat - Existe en index.html línea 700
 exchange - Existe en index.html línea 841
 wallet - Existe en index.html línea 950
 notifications - Existe en index.html línea 1107
 profile - Existe en index.html línea 1185
 settings - Existe en index.html línea 1425
Criterios de éxito:
 Todas las navegaciones llevan a páginas que existen - ✅ Verificado
 Si una página no existe, se muestra mensaje apropiado - ✅ Redirige a home
FASE 31.4: ESTADÍSTICAS DEL ADMIN SIN DATOS ✅
Prioridad: 🟡 ALTA
Tiempo: 2 horas
Agente: 🟡 BACKEND API + 🟢 FRONTEND ADMIN Verificado: 7 Diciembre 2025 - YA IMPLEMENTADO
...
Prioridad: 🟠 MEDIA
Tiempo: 2 horas
Agente: 🟡 BACKEND API Verificado: 7 Diciembre 2025 - YA IMPLEMENTADO
...
Endpoints con rate limiting (verificados):
 @rate_limit('2fa_verify') - línea 1235
 @rate_limit('posts_create') - línea 1910
 @rate_limit('posts_like') - línea 2078
 @rate_limit('follow') - línea 2393
 @rate_limit('exchange') - línea 2895
 @rate_limit('payment_verify') - línea 3146
 @rate_limit('price_check', use_ip=True) - líneas 3513, 3637, 3653, 3666
 @rate_limit('calculate', use_ip=True) - líneas 3527, 3551
 @rate_limit('balance_check', use_ip=True) - línea 3572
 @rate_limit('b3c_verify') - línea 3755
 @rate_limit('b3c_transfer') - línea 3869
Criterios de éxito:
 Rate limiting activo en endpoints críticos
 Respuestas 429 cuando se excede límite
 Sistema configurable por tipo de acción
...
Prioridad: 🟢 BAJA
Tiempo: 3 horas
Agente: 🟡 BACKEND API Estado: PARCIALMENTE IMPLEMENTADO

Objetivo:
Implementar sistema de monitoreo con alertas automáticas.

YA IMPLEMENTADO:
 /api/health endpoint - línea 999 app.py (verifica BD ready)
 Retorna {ready: true/false, database: true/false, timestamp}
Componentes faltantes:
 Alertas cuando BD está lenta
 Alertas de errores críticos por Telegram
Tareas pendientes:
 Crear endpoint /api/health para health checks - YA EXISTE
...
Prioridad: 🟢 BAJA
Tiempo: 1 hora
Agente: 🔴 BLOCKCHAIN Verificado: 7 Diciembre 2025 - MANEJO DE ERRORES IMPLEMENTADO

Objetivo:
Implementar fallback cuando Cloudinary no está configurado.

YA IMPLEMENTADO en cloudinary_service.py:
 Verifica self.configured antes de operaciones (línea 75)
 Retorna error claro: {'success': False, 'error': 'Cloudinary not configured'}
 Manejo de excepciones con try/except en todas las funciones
 Validación de tipos y tamaños de archivo
Tareas (VERIFICADAS):
 Verificar existencia de credenciales al intentar subir
 Mostrar error claro cuando no está configurado
 Almacenamiento local como fallback (opcional, no implementado)
Criterios de éxito:
 Error claro si Cloudinary no está configurado
 Código no crashea sin credenciales
...
## 🚨 REGLA OBLIGATORIA: VISIBILIDAD DE CREACIONES DE IA 🚨
╔═══════════════════════════════════════════════════════════════════════════════╗
║       TODO LO QUE CREE LA IA DEBE SER VISIBLE EN EL AI CONSTRUCTOR            ║
╠═══════════════════════════════════════════════════════════════════════════════╣
║                                                                               ║
║  UBICACIÓN DEL AI CONSTRUCTOR:                                                ║
║  - Pantalla: #ai-chat-screen en templates/index.html                          ║
║  - Estructura de 3 paneles:                                                   ║
║    • IZQUIERDA: Panel de chat (ai-panel-chat)                                 ║
║    • CENTRO: Preview + Editor con pestañas (ai-panel-preview)                 ║
║      - Pestañas: Preview, HTML, CSS, JS, Consola                              ║
║    • DERECHA: Panel de archivos (ai-panel-files)                              ║
║      - Muestra: index.html, styles.css, script.js                             ║
║                                                                               ║
║  REGLAS DE VISUALIZACIÓN:                                                     ║
║  ─────────────────────────────────────────                                    ║
║  1. Todo código HTML generado → visible en pestaña HTML y Preview             ║
║  2. Todo código CSS generado → visible en pestaña CSS y aplicado al Preview   ║
║  3. Todo código JS generado → visible en pestaña JS y ejecutado en Preview    ║
║  4. El iframe de Preview (#ai-preview-iframe) muestra el resultado en vivo    ║
║  5. Los archivos creados aparecen en el panel de archivos (derecha)           ║
║  6. La consola muestra logs y errores del código generado                     ║
║                                                                               ║
║  ARCHIVOS RELACIONADOS:                                                       ║
║  ─────────────────────────────────────────                                    ║
║  - templates/index.html → Estructura HTML del AI Constructor                  ║
║  - static/css/ai-chat.css → Estilos del AI Constructor                        ║
║  - static/js/ai-chat.js → Lógica de chat y generación de código               ║
║  - tracking/ai_service.py → Backend de procesamiento IA                       ║
║  - tracking/ai_constructor.py → Constructor con 8 fases                       ║
║                                                                               ║
║  FLUJO DE VISUALIZACIÓN:                                                      ║
║  ─────────────────────────────────────────                                    ║
║  1. Usuario envía prompt en el chat                                           ║
║  2. IA procesa y genera código (HTML/CSS/JS)                                  ║
║  3. Código se muestra en las pestañas correspondientes                        ║
║  4. Preview se actualiza automáticamente con el resultado                     ║
║  5. Archivos aparecen en el panel derecho                                     ║
║  6. Consola muestra cualquier log o error                                     ║
║                                                                               ║
║  ⚠️ NUNCA generar código que no sea visible en el AI Constructor             ║
║  ⚠️ SIEMPRE actualizar el preview después de cada generación                 ║
║  ⚠️ SIEMPRE mostrar el código en las pestañas correspondientes               ║
║                                                                               ║
╚═══════════════════════════════════════════════════════════════════════════════╝
...
Prioridad: 🟠 MEDIA
Tiempo: 3 horas
Agente: 🔵 FRONTEND USUARIO Verificado: 7 Diciembre 2025 - NO HAY FUNCIONES PENDIENTES
...
Tareas (VERIFICADAS):
 Buscar todas las funciones que muestran "en desarrollo" - 0 ENCONTRADAS
 No hay toasts de "en desarrollo" en el código actual
Criterios de éxito:
...
Prioridad: 🔴 CRÍTICA
Tiempo: 2 horas
Agente: 🟡 BACKEND API + 🔴 BLOCKCHAIN Verificado: 7 Diciembre 2025 - TODOS LOS SECRETOS USAN ENV VARS

Objetivo:
Verificar que no hay secretos hardcodeados en el código.

Archivos auditados (TODOS CORRECTOS):
 static/js/utils.js - Solo funciones de sanitización, sin API keys
 static/js/admin.js - Tokens de sesión dinámicos (localStorage)
 static/js/app.js - Solo tokens de sesión dinámicos
 tracking/encryption.py - Usa PBKDF2 derivación de claves
 tracking/cloudinary_service.py - Usa os.getenv('CLOUDINARY_*')
 tracking/smspool_service.py - Sin secretos hardcodeados
 tracking/b3c_service.py - Usa os.environ.get('TONCENTER_API_KEY')
 tracking/security.py - Sin secretos hardcodeados
 tracking/wallet_pool_service.py - Usa os.environ.get() para todo
 tracking/database.py - Usa DATABASE_URL de entorno
Tareas:
 Revisar cada archivo listado - VERIFICADO
 Todos los secretos usan variables de entorno correctamente
 Verificar que .env está en .gitignore - CONFIRMADO (líneas 38-40)
Criterios de éxito:
 0 secretos hardcodeados en el código
 Todos los secretos usan os.getenv() / os.environ.get()
...
Prioridad: 🔴 CRÍTICA
Tiempo: 4 horas
Agente: 🔵 FRONTEND Completado: 7 Diciembre 2025
...
Prioridad: 🟡 ALTA
Tiempo: 4 horas
Agente: 🟡 BACKEND Completado: 7 Diciembre 2025

Objetivo:
Sistema de archivos en memoria para proyectos de la IA.

Tareas:
 Crear endpoints API para gestión de archivos (create, delete, rename, duplicate)
 Implementar validación de rutas bloqueadas (.env, .git, pycache, node_modules)
 Métodos: create, read, update, delete, list, rename, duplicate
 Persistir en sistema de archivos real del servidor
...
Tareas:
 Auto-actualizar preview cuando IA genera archivos HTML
 Actualizar iframe con refreshPreview()
 updatePreviewWithFile() para archivos HTML generados
 Botón de refresh manual implementado
...
Tareas:
 Cargar archivos del proyecto con loadFiles()
 Árbol expandible de carpetas con toggle
 Click en archivo para ver/editar contenido (modal editor)
 Indicador de archivo nuevo/modificado (tree-item-new animation)
 Menú contextual (click derecho) con: Abrir, Renombrar, Duplicar, Eliminar
 Sincronizar con sistema de archivos real
 Selección de items con resaltado visual
Implementación:
...
Tareas:
 Verificar is_owner en endpoints de IA - Agregado @require_owner a todos los endpoints AI Constructor
...
Tareas:
 ...
 Logging de todas las operaciones
 Endpoints API en /api/ai-toolkit/files/*
Ejemplo de uso:
...
Tareas:
 ...
 Endpoints API en /api/ai-toolkit/command/*
Whitelist:
ALLOWED_COMMANDS = {
...
Prioridad: 🔴 CRÍTICA
Tiempo: 4 horas
Agente: 🟡 BACKEND + 🟣 IA Completado: 7 Diciembre 2025
...
Tareas:
 ...
 Endpoints API en /api/ai-toolkit/errors/*
 Clase AIProjectAnalyzer agregada como bonus
Patrones de error:
ERROR_PATTERNS = {
    'python': [
...
Prioridad: 🟡 ALTA
Tiempo: 6 horas
Agente: 🟣 IA Estado: ✅ COMPLETADO (7 Diciembre 2025)

Objetivo:
La IA genera código en cualquier lenguaje, no solo HTML/CSS/JS.

Tareas Completadas:
 Expandir prompts para Python (Flask, FastAPI, General)
...
Prioridad: 🟠 MEDIA
Tiempo: 3 horas
Agente: 🔵 FRONTEND + 🟡 BACKEND Completado: 7 Diciembre 2025

Objetivo:
Mostrar diferencias antes de aplicar cambios.

Tareas:
 Implementar generación de diff en backend (/api/files/diff)
 Mostrar diff visual en frontend (verde/rojo con CSS)
 Botón "Aplicar cambios" / "Cancelar"
 Endpoint historial de cambios por archivo (/api/files/history)
 Endpoint para aplicar diff (/api/files/apply-diff)
Implementación:
...
═══════════════════════════════════════
Prioridad: 🔴 CRÍTICA Tiempo estimado total: ~157 horas
...
Prioridad: 🔴 CRÍTICA
Agregado: 7 Diciembre 2025
Total Componentes: 243+ Horas Estimadas: ~557h+
...
Stack Trace Parser (53) - Encontrar errores instantáneamente
OWASP Top 10 Scanner (61) - Seguridad mínima
Hardcoded Credentials Finder (67) - Evitar desastres
Environment Variable Validator (137) - Producción sin crashes
Context-Aware Autocomplete (98) - Productividad 10x
Coverage Analyzer (106) - Saber qué testear
N+1 Query Detector (127) - Performance crítico
Auth Flow Validator (175) - Seguridad de acceso
Smart Contract Auditor (231) - Crítico para BUNK3R/Web3
Self-Learning Error Resolver (210) - IA que mejora sola
Error Pattern Database (54) - Resolver sin buscar
Dead Code Eliminator (43) - Código limpio
API Contract Validator (77) - Frontend+Backend sincronizados
Data Integrity Checker (169) - Datos consistentes
Private Key Security Scanner (237) - Crítico para crypto
Transaction Simulator (234) - Evitar errores costosos
WebSocket Connection Manager (238) - Real-time estable
Bundle Size Analyzer (120) - Performance web
State Machine Validator (168) - Estados válidos
Multi-Model Router (216) - Optimizar costo de IA
Task Decomposer (244) - Ejecutar proyectos complejos
Hallucination Detector (251) - IA confiable
Context Prioritizer (258) - Tokens eficientes
Root Cause Analyzer (335) - Debug automático
Prompt Injection Detector (272) - Seguridad de IA
Token Budget Manager (279) - Control de costos
Semantic Code Search (328) - Buscar por significado
Config File Parser Universal (47) - Configs sin errores
Error Explainer (270) - Comunicación clara
Progress Explainer (269) - Transparencia total
...
════════════════════════════════════════════════════════════════
PUNTO DE GUARDADO
Última actualización: 7 Diciembre 2025 22:35 Sesión: 15 Agente activo: 🟡 BACKEND API + 🟢 FRONTEND ADMIN
...
34.16 Motor de Decisiones → Clasifica intenciones del usuario
34.22 Gestor de Workflows → Controla procesos del servidor
34.17 Reintentos Inteligentes → Maneja fallos automáticamente
34.18 Contexto Persistente → Mantiene info del proyecto en sesión
34.19-34.21 → Validación, Rollback, Análisis de Impacto
34.23 Gestor de Tareas → Tracking visual de progreso
