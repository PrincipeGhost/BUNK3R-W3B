...
STATUS_PAGO_CONFIRMADO = "PAGO_CONFIRMADO"
STATUS_EN_TRANSITO = "EN_TRANSITO"
STATUS_ENTREGADO = "ENTREGADO"

VALID_STATUSES = [STATUS_RETENIDO, STATUS_PAGO_CONFIRMADO, STATUS_EN_TRANSITO, STATUS_ENTREGADO]

# Status display with emojis
STATUS_DISPLAY = {
    STATUS_RETENIDO: "🔴 RETENIDO",
    STATUS_PAGO_CONFIRMADO: "🟡 PAGO CONFIRMADO",
