...
from routes import auth_bp, blockchain_bp, admin_bp, user_bp, tracking_bp
...
logger.info("Blueprints registered: auth, blockchain, admin, user, tracking")
...
# ============================================================
# ENDPOINTS DE TRACKING - SEGUIMIENTO DE PAQUETES
# MIGRADO A routes/tracking_routes.py - 10 Diciembre 2025
# Endpoints: /api/trackings, /api/tracking/*, /api/stats, /api/delay-reasons, /api/statuses
# ============================================================
...
# MIGRADO A routes/blockchain_routes.py: /api/exchange/*, constantes CHANGENOW, TONCENTER, TON_CREDIT_RATES, calculate_credits_from_ton
...
# MIGRADO A routes/blockchain_routes.py: /api/ton/wallet-info, /api/wallet/merchant, /api/wallet/balance
