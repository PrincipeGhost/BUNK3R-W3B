...
##### Sistema de Quema de Tokens (BURN) - Opcional
```
┌─────────────────────────────────────────────────────────────────────────┐
│                        🔥 MECANISMO DE BURN                              │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  Quemar = Enviar tokens a dirección "muerta" (irrecuperables)            │
│  Dirección burn: EQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA         │
│                                                                          │
│  ¿CUÁNDO QUEMAR?                                                         │
│  ───────────────                                                         │
│  1. Parte de tu comisión (reduce supply, aumenta valor a largo plazo)    │
│  2. % de cada venta interna (deflacionario)                              │
│  3. Tokens de tesorería que no se usarán                                 │
│                                                                          │
│  EJEMPLO: Burn del 1% en cada venta interna                              │
│  ──────────────────────────────────────────                              │
│                                                                          │
│  Usuario vende 1,000 B3C:                                                │
│  ├── 950 B3C (95%) → Pool DEX (disponibles para otros)                   │
│  ├── 40 B3C (4%) → Tu comisión (en B3C o swap a TON)                     │
│  └── 10 B3C (1%) → Dirección BURN 🔥 (desaparecen para siempre)          │
│                                                                          │
│  EFECTO:                                                                 │
│  • Supply total disminuye con cada venta                                 │
│  • Token se vuelve más escaso                                            │
│  • Incentiva holdear (el valor sube a largo plazo)                       │
│                                                                          │
│  ⚠️ ADVERTENCIA: Tokens quemados NO se pueden recuperar                  │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
│  Burn B3C            │ Sin cambio         │ SUBE (menos supply) 📈       │
