...
## 🤖 COMPORTAMIENTO DEL AGENTE SEGÚN COMANDO

### Cuando el usuario escribe STATUS o 1:
```
El agente DEBE mostrar el TABLERO DE INICIO actualizado (el cuadro de arriba).
```

### Cuando el usuario escribe CONTINUAR o 2:
```
El agente busca la siguiente tarea pendiente y pregunta en qué rama trabajar.
```

### Cuando el usuario escribe 3, 4, 5 o 6 (activar agente):
...
╠═══════════════════════════════════════════════════════════════════════════════╣
║                                                                               ║
║  PASO 1: El agente muestra el comando Git que el usuario debe ejecutar       ║
║  ─────────────────────────────────────────────────────────────────────────────║
║                                                                               ║
║  Si el usuario escribe 3 o FRONTEND, el agente responde:                      ║
║  ┌─────────────────────────────────────────────────────────────────────────┐  ║
...
║  └─────────────────────────────────────────────────────────────────────────┘  ║
║                                                                               ║
║  Si el usuario escribe 4 o BACKEND, el agente responde:                       ║
║  ┌─────────────────────────────────────────────────────────────────────────┐  ║
...
║  └─────────────────────────────────────────────────────────────────────────┘  ║
║                                                                               ║
║  Si el usuario escribe 5 o ADMIN, el agente responde:                         ║
║  ┌─────────────────────────────────────────────────────────────────────────┐  ║
...
║  └─────────────────────────────────────────────────────────────────────────┘  ║
║                                                                               ║
║  Si el usuario escribe 6 o BLOCKCHAIN, el agente responde:                    ║
║  ┌─────────────────────────────────────────────────────────────────────────┐  ║
...
║                                                                               ║
║  ─────────────────────────────────────────────────────────────────────────────║
║  PASO 2: El agente ESPERA confirmación                                        ║
║  ─────────────────────────────────────────────────────────────────────────────║
║                                                                               ║
║  El agente NO hace nada hasta que el usuario escriba:                         ║
║  - "listo"                                                                    ║
║  - "ya"                                                                       ║
║  - "ok"                                                                       ║
║  - "done"                                                                     ║
...
### Cuando el usuario termina de trabajar:

```
El usuario debe ejecutar en Shell:
  git add .
  git commit -m "[ÁREA] Descripción"
  git push origin feature/[rama]

El agente le recuerda esto al final de cada sesión.
```
