...
# ============================================================
# ANALYTICS ENDPOINTS - Migrados desde app.py 10 Dic 2025
# ============================================================
...
# ============================================================
# SUPPORT ENDPOINTS - Migrados desde app.py 10 Dic 2025
# ============================================================
...
# ============================================================
# FAQ ADMIN ENDPOINTS - Migrados desde app.py 10 Dic 2025
# ============================================================
...
# ============================================================
# MASS MESSAGES ENDPOINTS - Migrados desde app.py 10 Dic 2025
# ============================================================
    ...
    try:
        ...
        with db_manager.get_connection() as conn:
            with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
                ...
                cur.execute(f"SELECT COUNT(*) as total FROM mass_messages m {where_clause}")
                total = cur.fetchone()['total']
...
def send_mass_message():
    ...
    try:
        ...
        send_type = data.get('sendType', 'now')
        ...
        with db_manager.get_connection() as conn:
            with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
                cur.execute("""
                    INSERT INTO mass_messages (title, content, message_type, recipient_type, status, scheduled_at, created_by)
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                    RETURNING *
                """, (title, content, msg_type, recipient_type, status, 
                      scheduled_at if send_type == 'scheduled' else None, admin_id))
